...
class BinaryExtended(Binary):
    def _content_image(
        ...
        **kwargs
        ...
        if not image_base64:
            # Since we set a placeholder for any missing image, the status
            # must be 200. In case one wants to configure a specific 404 page
            # (e.g. though nginx), a 404 status will cause troubles.
            status = 200
